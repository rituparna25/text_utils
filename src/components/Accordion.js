  ...
  return (
    <div className='container' style={myStyle}>
        ...
        <div className="accordion" id="accordionExample" >
            <div className="accordion-item">
                <h2 className="accordion-header">
                    ...
                    style={myStyle} data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        Accordion Item #1
                    </button>
                </h2>
        ...
        <div className="container my-3">
            <button type="button" onClick={enableDarkMode} className='btn btn-primary'>{button}</button>
        </div>
</div>
  )
}
